...
public class FactValueSplitterTest extends TestCase {
    ...
    // setSplitter(new FactValueSplitter());
    // }
    //
    // /**
    ...
    // */
    // public void testNothing() {
    // assertNotNull(getSplitter());
    // }
    //
    // public void testSimple() {
    // // because it appears in the output
    // String date = "my testdate";
    // getSplitter().setIso8601Date(date);
    //
    // List<ModelEntity> output = new ArrayList<ModelEntity>();
    //
    // for (StringFact f : getInput()) {
    // output.addAll(getSplitter().convert(f));
    // }
    //
    ...
    // .getCreatorKey());
    // assertEquals(date, user.getLastModified());
    // assertEquals("FactValueSplitter", user.getName());
    // }
    // {
    ...
    // // }
    //
    // public FactValueSplitter getSplitter() {
    // return this.splitter;
    // }
    //
    // public void setSplitter(FactValueSplitter splitter) {
