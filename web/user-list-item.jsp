...
<stripes:layout-definition>
    <%-- param: listItem == the item --%>
           <b>
            <c:choose>
             <c:when test="${listItem.instance.class.name == 'com.joelsgarage.prospector.client.model.User'}"> 
              <stripes:link beanclass="com.joelsgarage.show.action.UserActionBean">
