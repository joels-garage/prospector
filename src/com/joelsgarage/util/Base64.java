 ...
 * 
 * <p>
 * The <tt>options</tt> parameter, which appears in a few places, is used to pass several pieces
...
public class Base64 {
	 ...
	 * RFC3548: <a
	 * href="http://www.faqs.org/rfcs/rfc3548.html">http://www.faqs.org/rfcs/rfc3548.html</a>. It
	...
	public static String encodeFromFile(String filename) {
		...
		try {
			// Set up some useful variables
			java.io.File file = new java.io.File(filename);
			byte[] buffer = new byte[Math.max((int) (file.length() * 1.4), 40)]; // Need max()
			// for math on
			// small files
			// (v2.2.1)
			int length = 0;
